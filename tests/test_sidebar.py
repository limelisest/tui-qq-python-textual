...
class PixelThresholdTests(TestCase):
    def test_single_pane(self) -> None:
        self.assertEqual(sidebar_auto_hide_pixel_threshold(1), 800)

    def test_two_panes_vertical(self) -> None:
        self.assertEqual(sidebar_auto_hide_pixel_threshold(2, split_layout_horizontal=False), 800)

    def test_two_panes_horizontal(self) -> None:
        self.assertEqual(sidebar_auto_hide_pixel_threshold(2, split_layout_horizontal=True), 1000)

    def test_three_panes_vertical(self) -> None:
        self.assertEqual(sidebar_auto_hide_pixel_threshold(3, split_layout_horizontal=False), 800)

    def test_three_panes_horizontal(self) -> None:
        self.assertEqual(sidebar_auto_hide_pixel_threshold(3, split_layout_horizontal=True), 1200)

    def test_four_panes(self) -> None:
        self.assertEqual(sidebar_auto_hide_pixel_threshold(4), 1000)
        self.assertEqual(sidebar_auto_hide_pixel_threshold(4, split_layout_horizontal=True), 1000)


class ColumnThresholdTests(TestCase):
    def test_single_pane(self) -> None:
        self.assertEqual(sidebar_auto_hide_column_threshold(1), 101)

    def test_two_panes_vertical(self) -> None:
        self.assertEqual(sidebar_auto_hide_column_threshold(2, split_layout_horizontal=False), 101)

    def test_two_panes_horizontal(self) -> None:
        self.assertEqual(sidebar_auto_hide_column_threshold(2, split_layout_horizontal=True), 126)

    def test_three_panes_vertical(self) -> None:
        self.assertEqual(sidebar_auto_hide_column_threshold(3, split_layout_horizontal=False), 101)

    def test_three_panes_horizontal(self) -> None:
        self.assertEqual(sidebar_auto_hide_column_threshold(3, split_layout_horizontal=True), 151)

    def test_four_panes(self) -> None:
        self.assertEqual(sidebar_auto_hide_column_threshold(4), 126)
        self.assertEqual(sidebar_auto_hide_column_threshold(4, split_layout_horizontal=True), 126)


class IsSidebarNarrowTests(TestCase):
    """is_sidebar_narrow uses pixel_size first, falls back to cell size."""

    # --- Two panes vertical (threshold 800) ---
    ...
    # --- Two panes horizontal (threshold 1000) ---

    def test_two_horizontal_pixel_narrow(self) -> None:
        pixel = SimpleNamespace(width=950)
    ...
    # --- Three panes horizontal (threshold 1200) ---

    def test_three_horizontal_pixel_narrow(self) -> None:
        pixel = SimpleNamespace(width=1100)
    ...
    def test_three_horizontal_cell_narrow(self) -> None:
        cell = SimpleNamespace(width=140)
    ...
    def test_four_pane_cell_not_narrow(self) -> None:
        cell = SimpleNamespace(width=130)
